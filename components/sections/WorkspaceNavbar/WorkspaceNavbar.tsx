...
import { FiLogIn, FiArrowLeft, FiChevronDown } from "react-icons/fi"
      ...
      <div className="mx-auto max-w-7xl w-full flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          <Show when="signed-out">
            <SignInButton>
              <button className="flex items-center gap-2 bg-black text-white rounded-full font-medium text-sm h-9 px-4 cursor-pointer">
